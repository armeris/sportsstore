    ...
    render() {
        return <div className="m-3">
                 ...
                 <table className="table table-bordered table-striped">
                   ...
                   <tbody>
                     <CartDetailsRows cart={ this.props.cart } cartPrice={ this.props.cartPrice } updateQuantity={ this.props.updateCartQuantity } removeFromCart={ this.props.removeFromCart }/>
                   </tbody>
                 </table>
